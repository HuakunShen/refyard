...
| R15  | Worker static PWA, API-only CLI, exact hosted API origin                                                          | `pnpm check`; `pnpm test:web-host`; `wrangler deploy --dry-run`; `pnpm test:e2e`; `pnpm pack:smoke`                                                                                                                                                                                                                    | **Implemented locally. Check 8/8; unit 252; Worker dry-run read 75 files; Worker tests 4/4; full e2e 105/105 across Chromium, Firefox and WebKit; package smoke 14 steps. No live account/domain/tunnel was used.**                                                                                                               | `docs/evidence/release-matrix.md`; `docs/evidence/security.md`                                                       |
