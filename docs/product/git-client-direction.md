...
3. Add history search and filters. **Implemented:** compact message search plus expandable author, observed ref, UTC date, SHA and known-file filters. Apply/Enter and Clear own fresh cursor-stable page chains; sparse results retain commit actions and the inspector without inventing graph edges. The narrow layout wraps controls and preserves bounded virtualization. [Local verification and screenshots](../evidence/2026-09-18-history-search.md).
4. Add keyboard navigation and command palette.
5. Improve contextual feedback for branch/network/operation state.

Status as of 2026-09-18: items 1, 2 and 3 are implemented and locally verified. Items 4 and 5 remain Phase C work.
