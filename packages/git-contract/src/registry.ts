...
export const CONTRACT_SCHEMAS: Readonly<Record<string, z.ZodType>> = {
  ...
  ProviderDeviceStartRequest: providerDeviceStartRequestSchema,
  ProviderDeviceStartResponse: providerDeviceStartResponseSchema,
  ProviderDeviceStatusQuery: providerDeviceStatusQuerySchema,
  ProviderDeviceStatusResponse: providerDeviceStatusResponseSchema,
